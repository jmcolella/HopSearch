...
The complete list of hops and some of the information was gathered from the BreweryDB API; all other information was research and provided by the creator, John Colella, creating a unique experience for the user.
...
HopSearch is built on Rails 4 with React front end views. Bootstrap 3 was used as the front end framework along with additional custom CSS styling and JavaScript functionality.
